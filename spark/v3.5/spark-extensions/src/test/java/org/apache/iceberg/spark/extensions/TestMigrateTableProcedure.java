...
public class TestMigrateTableProcedure extends SparkExtensionsTestBase {
  ...
  public void testMigrate() throws IOException {
    assumeThat(catalogName).isEqualTo("spark_catalog");
    String location = Files.createTempDirectory(temp, "junit").toString();
    sql(
    ...
    assertThat(result).as("Should have added one file").isEqualTo(1);
