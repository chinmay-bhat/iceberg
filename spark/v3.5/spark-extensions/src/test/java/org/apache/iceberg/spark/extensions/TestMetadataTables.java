...
public class TestMetadataTables extends SparkExtensionsTestBase {
  ...
  public void testUnpartitionedTable() throws Exception {
    ...
    assertThat(actualFiles).as("Metadata table should return 2 files").hasSize(2);

    List<Record> expectedFiles =
        Stream.concat(expectedDataFiles.stream(), expectedDeleteFiles.stream())
            .collect(Collectors.toList());
    assertThat(expectedFiles).as("Should have 2 files manifest entries").hasSize(2);
    TestHelpers.assertEqualsSafe(
  ...
  public void testPartitionedTable() throws Exception {
    ...
    assertThat(expectedDeleteManifests).as("Should have 2 delete manifests").hasSize(2);
    ...
    assertThat(actualPartitionsWithProjection)
        ...
        .hasSize(2);
    for (int i = 0; i < 2; ++i) {
      assertThat(actualPartitionsWithProjection.get(i).get(0)).isEqualTo(1);
    }
  ...
  public void testAllFilesUnpartitioned() throws Exception {
    ...
    assertThat(results).as("Table should be cleared").hasSize(0);
  ...
  public void testMetadataLogEntries() throws Exception {
    ...
    assertThat(metadataLogWithProjection)
        .as("metadataLogEntries table should return 3 row")
        .hasSize(3);
    assertEquals(
  ...
  public void testSnapshotReferencesMetatable() throws Exception {
    ...
    assertThat(references).as("Refs table should return 2 branches").hasSize(2);
    List<Row> tags =
    ...
    assertThat(mainBranch.get(0).getAs("name").equals("main")).isTrue();
    assertThat(mainBranch.get(0).getAs("type").equals("BRANCH")).isTrue();
    assertThat(mainBranch.get(0).getAs("snapshot_id").equals(currentSnapshotId)).isTrue();

    List<Row> testBranch =
        spark
            .sql("SELECT * FROM " + tableName + ".refs WHERE name = 'testBranch' AND type='BRANCH'")
            .collectAsList();
    assertThat(testBranch.get(0).getAs("name").equals("testBranch")).isTrue();
    assertThat(testBranch.get(0).getAs("type").equals("BRANCH")).isTrue();
    assertThat(testBranch.get(0).getAs("snapshot_id").equals(currentSnapshotId)).isTrue();
    assertThat(testBranch.get(0).getAs("max_reference_age_in_ms").equals(10L)).isTrue();
    assertThat(testBranch.get(0).getAs("min_snapshots_to_keep").equals(20L)).isTrue();
    assertThat(testBranch.get(0).getAs("max_snapshot_age_in_ms").equals(30L)).isTrue();
    ...
    List<Row> testTag =
        spark
            ...
            .collectAsList();
    assertThat(testTag.get(0).getAs("name").equals("testTag")).isTrue();
    assertThat(testTag.get(0).getAs("type").equals("TAG")).isTrue();
    assertThat(testTag.get(0).getAs("snapshot_id").equals(currentSnapshotId)).isTrue();
    assertThat(testTag.get(0).getAs("max_reference_age_in_ms").equals(50L)).isTrue();
        ...
        spark
            .sql(
                "SELECT name,type,snapshot_id,max_reference_age_in_ms,min_snapshots_to_keep FROM "
                    ...
                    + ".refs where type='TAG'")
            .collectAsList();
    assertThat(testTagProjection.get(0).getAs("name").equals("testTag")).isTrue();
    assertThat(testTagProjection.get(0).getAs("type").equals("TAG")).isTrue();
    assertThat(testTagProjection.get(0).getAs("snapshot_id").equals(currentSnapshotId)).isTrue();
    assertThat(testTagProjection.get(0).getAs("max_reference_age_in_ms").equals(50L)).isTrue();
    assertThat(testTagProjection.get(0).getAs("max_reference_age_in_ms") == null).isTrue();
    ...
    List<Row> mainBranchProjection =
        spark
            ...
            .collectAsList();
    assertThat(mainBranchProjection.get(0).getAs("name").equals("main")).isTrue();
    assertThat(mainBranchProjection.get(0).getAs("type").equals("BRANCH")).isTrue();
    ...
    List<Row> testBranchProjection =
        spark
            ...
            .collectAsList();
    assertThat(testBranchProjection.get(0).getAs("name").equals("testBranch")).isTrue();
    assertThat(testBranchProjection.get(0).getAs("type").equals("BRANCH")).isTrue();
    assertThat(testBranchProjection.get(0).getAs("snapshot_id").equals(currentSnapshotId)).isTrue();
    assertThat(testBranchProjection.get(0).getAs("max_reference_age_in_ms").equals(10L)).isTrue();
  }
